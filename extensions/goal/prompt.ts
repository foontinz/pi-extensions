...
function renderPacket(
  ...
  return [
    ...
    "- phase_candidate_complete closes only the active phase. goal_candidate_complete is allowed only after the entire objective and all evidenced acceptance criteria are complete—never merely because the current rolling horizon ended. Both are verification claims, not success.",
